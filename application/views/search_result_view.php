...
<div class="row">
          <div class="col-sm-12 videoGridHeader">
             <span><?php echo $searchPageTitle?></span>
             <span class="ml-auto">Order by: </span>
             <a href="<?php echo base_url().$newUrl.'&orderBy=uploadDate'?>" class="px-2">Upload date |</a>
             <a href="<?php echo base_url().$newUrl.'&orderBy=views'?>">Most viewed</a>
          </div>
             <?php
